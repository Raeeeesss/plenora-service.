...
export default function Footer() {
  ...
  const phoneDisplay1 = settings?.primary_phone || '+91 8139895446';
  const phoneTel1 = `tel:${phoneDisplay1.replace(/\s+/g, '')}`;
  const phoneDisplay2 = settings?.secondary_phone || '+91 9074810790';
  const phoneTel2 = `tel:${phoneDisplay2.replace(/\s+/g, '')}`;
  const supportEmail = settings?.support_email || 'plenoraservice@gmail.com';
  const whatsappUrl = settings?.whatsapp_number 
    ? `https://wa.me/${settings.whatsapp_number.replace(/\D/g, '')}` 
    : 'https://wa.me/918139895446';
      ...
      <div className="footer-cta-wrapper">
        <div className="home-process-cta-banner">
          ...
          <div className="cta-banner-right">
            ...
            <a href={phoneTel1} className="cta-btn-call">
        ...
        <div className="footer-main-container">
              ...
              <div className="footer-contact-items">
                <div className="footer-contact-item">
                  ...
                  <div className="footer-contact-text">
                    <a href={phoneTel1} className="footer-contact-heading">{phoneDisplay1}</a>
                    <a href={phoneTel2} className="footer-contact-subtext" style={{ color: 'rgba(255, 255, 255, 0.85)', textDecoration: 'none' }}>{phoneDisplay2}</a>
                  </div>
                </div>
                ...
                <div className="footer-contact-item">
                  ...
                  <div className="footer-contact-text">
                    <a href={`mailto:${supportEmail}`} className="footer-contact-heading">{supportEmail}</a>
                    <span className="footer-contact-subtext">{settings?.sla_response_time || 'We reply within 30 minutes'}</span>
                  </div>
                </div>
                ...
                <div className="footer-contact-item">
                  ...
                  <div className="footer-contact-text">
                    ...
                    <span className="footer-contact-subtext">{settings?.operating_address || 'Malappuram, Kerala, India'}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="footer-bottom-brand-section">
            ...
            <div className="footer-social-links footer-centered-socials">
              <a href={settings?.facebook_url || "https://facebook.com"} target="_blank" rel="noopener noreferrer" className="footer-social-icon" aria-label="Facebook">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                </svg>
              </a>
              <a href={settings?.instagram_url || "https://instagram.com"} target="_blank" rel="noopener noreferrer" className="footer-social-icon" aria-label="Instagram">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="footer-social-icon" aria-label="WhatsApp">
